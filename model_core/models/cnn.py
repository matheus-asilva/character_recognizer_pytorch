...
class ConvBlock(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        Args:
            x (torch.Tensor): torch tensor of an image contining dimensions (B, C, H, W)
...
class CNN(nn.Module):
    ...
    Args:
        data_config (Dict[str, Any]): Dictionary containing information about data
        args (argparse.Namespace): Dictionary containing model parameters. Default is None
    """
