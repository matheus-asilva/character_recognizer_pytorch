...
class EMNISTLines(BaseDataModule):
    """EMNIST Lines dataset: synthetic handwritting lines dataset made from EMNIST characters.
    """
...
def convert_strings_to_labels(strings: Sequence[str], mapping: Dict[str, int], length: int, with_start_end_tokens: bool) -> np.ndarray:
    """
